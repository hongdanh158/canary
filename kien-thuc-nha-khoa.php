<?php include('header.php') ?>
	...
	<section class="block block-dental-knowledge background-light-primary">
		...
		<div class="block-content container row mt-6rem">
			<div class="col col-4 border-right-primary-2px">
				...
				<ul class="nav nav-tabs flex-column" id="myTab" role="tablist">
				  ...
				  <li class="nav-item" role="presentation">
				    <button class="nav-link" id="h-tab-2" data-bs-toggle="tab" data-bs-target="#tab-2" type="button" role="tab" aria-controls="tab-2" aria-selected="false"><i class="fal fa-lightbulb fa-fw"></i> Lây nhiễm chéo - Kiểm soát lây nhiễm.</button>
				  </li>
				  <li class="nav-item" role="presentation">
				    <button class="nav-link" id="h-tab-3" data-bs-toggle="tab" data-bs-target="#tab-3" type="button" role="tab" aria-controls="tab-3" aria-selected="false"><i class="fal fa-lightbulb fa-fw"></i> Viêm nướu - Viêm nha chu.</button>
				  </li>
				</ul>
			</div>
		...
		<div class="modal" id="modal" tabindex="-1">
			<div class="modal-dialog modal-dialog-scrollable modal-xl container">
