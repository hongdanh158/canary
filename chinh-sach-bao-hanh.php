	...
	<section class="block block-policy-detail">
		...
		<div class="block-content container">
			<ul class="list-policy">
				<li><p data-bs-toggle="modal" data-bs-target="#modal" >TẨY TRẮNG RĂNG</p></li>
				<li><p data-bs-toggle="modal" data-bs-target="#modal" >TRÁM RĂNG</p></li>
				<li><p data-bs-toggle="modal" data-bs-target="#modal" >ĐIỀU TRỊ TUỶ</p></li>
				<li><p>PHỤC HÌNH SỨ</p>
					<ul>
						<li><p data-bs-toggle="modal" data-bs-target="#modal" >MÃO SỨ</p></li>
						<li><p data-bs-toggle="modal" data-bs-target="#modal" >MẶT DÁN SỨ</p></li>
					</ul>
				</li>
				<li><p data-bs-toggle="modal" data-bs-target="#modal" >HÀM GIẢ</p></li>
				<li><p>CHỈNH NHA</p>
					<ul>
						<li data-bs-toggle="modal" data-bs-target="#modal" ><p>MÃO SỨ</p></li>
						<li data-bs-toggle="modal" data-bs-target="#modal" ><p>MẶT DÁN SỨ</p></li>
					</ul>
				</li>
				<li><p>CẤY GHÉP IMPLANT</p>
					<ul>
						<li data-bs-toggle="modal" data-bs-target="#modal" ><p>MÃO SỨ</p></li>
						<li data-bs-toggle="modal" data-bs-target="#modal" ><p>MẶT DÁN SỨ</p></li>
					</ul>
				</li>
				<li><p data-bs-toggle="modal" data-bs-target="#modal" >ĐIỀU TRỊ CƯỜI HỞ NƯỚU</p></li>
			</ul>
		</div>
	</section>
	<section class="block block-policy-detail">
		...
		<div class="block-content container">
			<ul class="list-policy">
				<li><p data-bs-toggle="modal" data-bs-target="#modal" >QUY ĐỊNH</p></li>
				<li><p>THANH TOÁN</p>
					<ul>
						<li><p data-bs-toggle="modal" data-bs-target="#modal" >MÃO SỨ</p></li>
						<li><p data-bs-toggle="modal" data-bs-target="#modal" >MẶT DÁN SỨ</p></li>
				...
				<li><p data-bs-toggle="modal" data-bs-target="#modal" >BẢO MẬT THÔNG TIN</p></li>
			</ul>
		</div>
	</section>
