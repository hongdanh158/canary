<?php include('header.php') ?>
	<section class="main-slider">
		...
		<div class="slider">
			...
			<div class="slide">
				<img src="images/dich-vu-banner.jpg" alt="">
			</div>
		</div>
	</section>
	<section class="block block-service">
		...
		<div class="clear"></div>
		<div class="block-service-article">
			<div class="block-service-article-title">
				<div class="container">
					<span>NHA CHU</span>
				</div>
			</div>
			<div class="block-service-article-list container">
				<div class="block-service-article-item d-flex flex-sm-column flex-md-row flex-xs-column">
					...
					<div class="right">
						<div class="article-title">
							<a href="#"><span class="number">1</span> CẠO VÔI RĂNG</a>
						</div>
						<div class="article-description">
							<ul>
								<li>Vôi răng hình thành từ bựa bám sau khi ăn , nhờ một số thành phần trong nước bọt sẽ làm bựa bám cứng dần gọi là vôi răng.</li>
				...
				<div class="block-service-article-item d-flex flex-sm-column flex-md-row flex-xs-column">
					...
					<div class="right">
						<div class="article-title">
							<a href="#"><span class="number">2</span> XỬ LÝ MẶT GỐC RĂNG</a>
						</div>
						<div class="article-description">
							<ul>
								<li>Vôi răng hình thành từ bựa bám sau khi ăn , nhờ một số thành phần trong nước bọt sẽ làm bựa bám cứng dần gọi là vôi răng.</li>
				...
				<div class="block-service-article-item d-flex flex-sm-column flex-md-row flex-xs-column">
					...
					<div class="right">
						<div class="article-title">
							<a href="#"><span class="number">3</span> ĐIỀU TRỊ CƯỜI HỞ NƯỚU</a>
						</div>
						<div class="article-description">
							<ul>
								<li>Vôi răng hình thành từ bựa bám sau khi ăn , nhờ một số thành phần trong nước bọt sẽ làm bựa bám cứng dần gọi là vôi răng.</li>
				...
				<div class="block-service-article-item d-flex flex-sm-column flex-md-row flex-xs-column">
					...
					<div class="right">
						<div class="article-title">
							<a href="#"><span class="number">4</span> GHÉP NƯỚU / MÔ LIÊN KẾT</a>
						</div>
						<div class="article-description">
							<ul>
								<li>Vôi răng hình thành từ bựa bám sau khi ăn , nhờ một số thành phần trong nước bọt sẽ làm bựa bám cứng dần gọi là vôi răng.</li>
