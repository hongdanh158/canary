							...
							<div class="mb-3rem">
								...
								<div class="row mb-3">
									<div class="col-md-6 d-flex justify-content-start">
										<a class="btn btn-outline-primary mr-2" data-bs-toggle="modal" data-bs-target="#modal"  style="min-width: 315px;"> THÔNG TIN KHÁCH HÀNG CUNG CẤP</a>
									</div>
									<div class="col-md-6 d-flex justify-content-end">
										<a class="btn btn-outline-primary mr-2" href="#" style="min-width: 315px;"> TẬP TIN HOÁ ĐƠN ĐỎ </a>
									</div>
									<div class="col-md-12 d-flex justify-content-end mt-3rem">
										<a class="btn btn-outline-primary mr-2" href="#" style="min-width: 315px;"> TẬP TIN HỒ SƠ ĐIỀU TRỊ </a>
									</div>
								</div>
							</div>							
						</div>
						<div class="col-md-12" style="padding: 6rem; padding-top: 0;">
